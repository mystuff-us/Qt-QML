		...
		: QAbstractListModel{parent}
{
	...
	// Photo by <a href="/photographer/elkojote-44244">elkojote</a> on <a href="/">Freeimages.com</a>
	addAudio("Eine Kleine Nachtmusik",
					 "Wolfgang Amadeus Mozart",
					 QUrl("qrc:/MusicPlayerApp/assets/audio/eine_kleine_nachtmusik.mp3"),
					 QUrl("qrc:/MusicPlayerApp/assets/images/song_1.jpg"));

	// Photo by <a href="/photographer/niga-29077">niga</a> on <a href="/">Freeimages.com</a>
	addAudio("Symphony No. 5",
					 "Ludwig Van Beethoven",
					 QUrl("qrc:/MusicPlayerApp/assets/audio/symphony_no_5.mp3"),
					 QUrl("qrc:/MusicPlayerApp/assets/images/song_2.jpg"));

	// Photo by <a href="/photographer/ziegs-43574">ziegs</a> on <a href="/">Freeimages.com</a>
	addAudio("Air on the G String",
					 "Johann Sebastian Bach",
					 QUrl("qrc:/MusicPlayerApp/assets/audio/air_on_the_g_string.mp3"),
					 QUrl("qrc:/MusicPlayerApp/assets/images/song_3.jpg"),
					 QUrl("qrc:/MusicPlayerApp/assets/videos/video_1.avi"));
}
